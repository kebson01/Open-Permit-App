...
const COMMERCIAL_ZONES = [
  { id: "ev-chargers",       label: "EV Charging Station",        desc: "Electric vehicle charging station installation",    points: "1114,448 876,621 927,655 1114,485",                                                                                color: "rgba(234,179,8,0.45)",   stroke: "#eab308" },
  { id: "light-pole",        label: "Light Pole / Utility",       desc: "Light pole installation permit",                   points: "1018,310 1045,311 1029,591 1011,591",                                                                              color: "rgba(234,179,8,0.42)",   stroke: "#eab308" },
  { id: "underground-drain", label: "Underground Drainage",       desc: "Underground drainage / stormwater system",         points: "605,580 498,626 661,766 902,767 911,748 722,641",                                                                  color: "rgba(6,182,212,0.35)",   stroke: "#06b6d4" },
  { id: "asphalt",           label: "Asphalt / Milling & Paving", desc: "Asphalt repair, milling & paving",                 points: "334,408 738,280 829,321 428,459",                                                                                  color: "rgba(107,114,128,0.38)", stroke: "#6b7280" },
  { id: "seal-coat",         label: "Seal Coat & Striping",       desc: "Seal coat and parking lot striping",               points: "415,477 814,325 977,377 661,546 629,534 565,560",                                                                  color: "rgba(107,114,128,0.28)", stroke: "#9ca3af" },
  { id: "sidewalk-rep",      label: "Sidewalk / Curb",            desc: "Sidewalk repair / curb replacement",               points: "266,427 530,611 569,589 304,410",                                                                                  color: "rgba(156,163,175,0.35)", stroke: "#9ca3af" },
  { id: "pavement",          label: "Pavement / Earthwork",       desc: "Pavement construction or earthwork permit",        points: "1210,233 1072,398 1180,439 1088,540 1055,574 1013,767 1276,763 1406,433 1404,335 1322,245",                         color: "rgba(245,158,11,0.28)",  stroke: "#f59e0b" },
  { id: "utility-boring",    label: "Utility Boring",             desc: "Underground utility boring permit",                points: "120,510 119,584 503,691 503,597 295,525 169,485",                                                                  color: "rgba(139,92,246,0.32)",  stroke: "#8b5cf6" },
  { id: "signs",             label: "Sign Permit",                desc: "Commercial signage installation",                  points: "955,614 952,665 1017,693 1022,630",                                                                                color: "rgba(234,179,8,0.5)",    stroke: "#eab308" },
];
