...
const COMMERCIAL_ZONES = [
  ...
  { id: "asphalt",           label: "Asphalt / Milling & Paving", desc: "Asphalt repair, milling & paving",                 points: "334,408 738,280 829,321 428,459",                                                                                  color: "rgba(30,41,59,0.5)",     stroke: "#1e293b" },
  { id: "seal-coat",         label: "Seal Coat & Striping",       desc: "Seal coat and parking lot striping",               points: "415,477 814,325 977,377 661,546 629,534 565,560",                                                                  color: "rgba(100,116,139,0.45)", stroke: "#64748b" },
  { id: "sidewalk-rep",      label: "Sidewalk / Curb",            desc: "Sidewalk repair / curb replacement",               points: "266,427 530,611 569,589 304,410",                                                                                  color: "rgba(203,213,225,0.55)", stroke: "#94a3b8" },
