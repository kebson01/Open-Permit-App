...
import { Building2, Map, Calculator, Menu, X, MessageCircle, Send, Settings, LayoutDashboard, Database, ClipboardList } from "lucide-react";
...
export default function Layout({ children, currentPageName }) {
  ...
  const adminLinks = currentUser?.role === "admin"
    ? [{ name: "City Manager", page: "AdminCityManager", icon: Settings }, { name: "Property Import", page: "AdminPropertyImport", icon: Database }, { name: "Permit Records", page: "AdminPermitRecords", icon: ClipboardList }]
