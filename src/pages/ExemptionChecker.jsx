...
export default function ExemptionChecker() {
  ...
  return (
    <div style={{ background: "#f8f9ff", minHeight: "100vh", paddingBottom: 60 }}>
      {/* Header */}
      <div style={{ background: "linear-gradient(135deg, #003FB1 0%, #004ac6 60%, #0066ff 100%)", padding: "44px 24px 40px" }}>
        <div className="max-w-3xl mx-auto">
          <h1 style={{ color: "white", fontSize: 30, fontWeight: 800, fontFamily: "'Manrope', sans-serif", marginBottom: 10 }}>
            Do I Need a Permit?
          </h1>
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: 15, fontFamily: "'Plus Jakarta Sans', sans-serif", maxWidth: 520, lineHeight: 1.6 }}>
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        ...
        <div style={{ background: "#fffbeb", border: "1px solid #fde68a", borderRadius: 12, marginBottom: 20, overflow: "hidden" }}>
          <button onClick={() => setBannerOpen(p => !p)}
            ...
            <span style={{ flex: 1, fontSize: 13, fontWeight: 600, color: "#92400e", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
          ...
          {bannerOpen && (
            <div style={{ padding: "0 16px 14px 42px" }}>
              <p style={{ fontSize: 12, color: "#78350f", fontFamily: "'Plus Jakarta Sans', sans-serif", lineHeight: 1.6, margin: 0 }}>
        ...
        {/* Steps */}
        <div style={{ background: "white", border: "1px solid #e8eaf0", borderRadius: 18, padding: "28px 24px", boxShadow: "0 2px 12px rgba(0,74,198,0.07)" }}>
